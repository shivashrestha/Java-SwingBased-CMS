...
public class EditOnFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EditOnFrame frame = new EditOnFrame();
	...
	private JPanel getPhonenoField() {
		if (phonenoField == null) {
			...
			phonenoField.setBorder(new TitledBorder(null, "Edit Following Items", TitledBorder.LEADING, TitledBorder.TOP, null, null));
			phonenoField.setBounds(22, 21, 485, 368);
		...
		if (btnUpdate == null) {
			...
			btnUpdate.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					s.setRollno(Integer.parseInt(rollnoField.getText()));
			...
			btnUpdate.setBounds(373, 321, 89, 23);
		}
		return btnUpdate;
	}
